...
import { Currency, CurrencyAmount, Fraction, JSBI, Percent, Token, TokenAmount, WETH } from 'tropic-swap'
    ...
    <>
      ...
      <RowBetween mb="1rem">
        ...
        <RowFixed>
          ...
          <CurrencyLogo size="20px" style={{ marginLeft: '8px' }} currency={Currency.FINDORA} />
        </RowFixed>
      </RowBetween>
    </>
  )
